...
class SessionCmd1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SessionCmd1', createEmptyInstance: create)
...
class SessionResp1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SessionResp1', createEmptyInstance: create)
...
class SessionCmd0 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SessionCmd0', createEmptyInstance: create)
...
class SessionResp0 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('SessionResp0', createEmptyInstance: create)
        ..e<$0.Status>(1, 'status', $pb.PbFieldType.OE,
            defaultOrMaker: $0.Status.Success,
            valueOf: $0.Status.valueOf,
            enumValues: $0.Status.values)
...
class Sec1Payload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Sec1Payload', createEmptyInstance: create)
        ..oo(0, [20, 21, 22, 23])
        ..e<Sec1MsgType>(1, 'msg', $pb.PbFieldType.OE,
