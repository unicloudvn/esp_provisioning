...
class S0SessionCmd extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('S0SessionCmd', createEmptyInstance: create)
...
class S0SessionResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('S0SessionResp', createEmptyInstance: create)
...
class Sec0Payload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('Sec0Payload', createEmptyInstance: create)
        ..oo(0, [20, 21])
        ..e<Sec0MsgType>(1, 'msg', $pb.PbFieldType.OE,
