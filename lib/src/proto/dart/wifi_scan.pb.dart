...
class CmdScanStart extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdScanStart', createEmptyInstance: create)
        ..aOB(1, 'blocking')
        ..aOB(2, 'passive')
...
class RespScanStart extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespScanStart', createEmptyInstance: create)
        ..hasRequiredFields = false;
...
class CmdScanStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdScanStatus', createEmptyInstance: create)
        ..hasRequiredFields = false;
...
class RespScanStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespScanStatus', createEmptyInstance: create)
        ..aOB(1, 'scanFinished')
...
class CmdScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdScanResult', createEmptyInstance: create)
...
class WiFiScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('WiFiScanResult', createEmptyInstance: create)
        ...
        ..e<$3.WifiAuthMode>(5, 'auth', $pb.PbFieldType.OE,
            defaultOrMaker: $3.WifiAuthMode.Open,
            valueOf: $3.WifiAuthMode.valueOf,
            enumValues: $3.WifiAuthMode.values)
        ..hasRequiredFields = false;
...
class RespScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespScanResult', createEmptyInstance: create)
        ..pc<WiFiScanResult>(1, 'entries', $pb.PbFieldType.PM,
...
class WiFiScanPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WiFiScanPayload',
      createEmptyInstance: create)
    ..oo(0, [10, 11, 12, 13, 14, 15])
    ..e<WiFiScanMsgType>(1, 'msg', $pb.PbFieldType.OE,
        defaultOrMaker: WiFiScanMsgType.TypeCmdScanStart,
        valueOf: WiFiScanMsgType.valueOf,
        enumValues: WiFiScanMsgType.values)
    ..e<$0.Status>(2, 'status', $pb.PbFieldType.OE,
