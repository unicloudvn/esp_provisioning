...
class CmdGetStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdGetStatus', createEmptyInstance: create)
...
class RespGetStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespGetStatus', createEmptyInstance: create)
        ..oo(0, [10, 11])
        ..e<$0.Status>(1, 'status', $pb.PbFieldType.OE,
            defaultOrMaker: $0.Status.Success,
            valueOf: $0.Status.valueOf,
            enumValues: $0.Status.values)
        ..e<$3.WifiStationState>(2, 'staState', $pb.PbFieldType.OE,
            defaultOrMaker: $3.WifiStationState.Connected,
            valueOf: $3.WifiStationState.valueOf,
            enumValues: $3.WifiStationState.values)
        ..e<$3.WifiConnectFailedReason>(10, 'failReason', $pb.PbFieldType.OE,
            defaultOrMaker: $3.WifiConnectFailedReason.AuthError,
            valueOf: $3.WifiConnectFailedReason.valueOf,
            enumValues: $3.WifiConnectFailedReason.values)
        ..aOM<$3.WifiConnectedState>(11, 'connected',
            subBuilder: $3.WifiConnectedState.create)
        ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set staState($3.WifiStationState v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(10)
  set failReason($3.WifiConnectFailedReason v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(11)
  set connected($3.WifiConnectedState v) {
    setField(11, v);
  }
...
class CmdSetConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdSetConfig', createEmptyInstance: create)
...
class RespSetConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespSetConfig', createEmptyInstance: create)
        ..e<$0.Status>(1, 'status', $pb.PbFieldType.OE,
            defaultOrMaker: $0.Status.Success,
            valueOf: $0.Status.valueOf,
            enumValues: $0.Status.values)
...
class CmdApplyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('CmdApplyConfig', createEmptyInstance: create)
        ..hasRequiredFields = false;
...
class RespApplyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo('RespApplyConfig', createEmptyInstance: create)
        ..e<$0.Status>(1, 'status', $pb.PbFieldType.OE,
            defaultOrMaker: $0.Status.Success,
            valueOf: $0.Status.valueOf,
            enumValues: $0.Status.values)
...
class WiFiConfigPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WiFiConfigPayload',
      createEmptyInstance: create)
    ..oo(0, [10, 11, 12, 13, 14, 15])
    ..e<WiFiConfigMsgType>(1, 'msg', $pb.PbFieldType.OE,
    ...
    ..aOM<CmdApplyConfig>(14, 'cmdApplyConfig',
        subBuilder: CmdApplyConfig.create)
    ..aOM<RespApplyConfig>(15, 'respApplyConfig',
