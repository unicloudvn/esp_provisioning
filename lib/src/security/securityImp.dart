...
import 'package:esp_provisioning/src/crypt.dart';
import 'package:esp_provisioning/src/proto/dart/sec1.pb.dart';
import 'package:esp_provisioning/src/proto/dart/session.pb.dart';
...
class Security1 implements ProvSecurity {
  String? pop;
  final bool verbose;
  late SecurityState sessionState;
  ...
  Future<SessionData> setup0Response(SessionData responseData) async {
    ...
    crypt.init(Uint8List.fromList(sharedK), deviceRandom);
    _verbose(
